...
合计: **571,363** 行代码（覆盖前 5 种语言、共 **1190** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 435,461 | 17,570 | 45,969 | 643 |
| Json | 99,047 | 0 | 0 | 15 |
| Toml | 13,932 | 864 | 2,184 | 373 |
| Yaml | 11,094 | 486 | 1,370 | 52 |
| Python | 8,528 | 874 | 1,576 | 107 |
...
- **最新版本**: `0.12.13` (2026-09-10)
- **最近提交**: 2026-09-10
- **Release 含资产**: 42 个

## 流行度

- **Star**: 89,690 · **Fork**: 3,563 · **开放 issue**: 9,254 · **贡献者**: 600

## 累计统计

- **发布数**: 311 · **已合并 PR**: 10365 · **开放 PR**: 525 · **已关闭 issue**: 6897 · **开放 issue**: 2357 · **提交数**: 10424
...
在 [repology.org](https://repology.org/project/uv) 上共有 **416** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**187** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Debian unstable | `0.9.17` | ⚠️ outdated |
| Debian 14 | `0.9.17` | ⚠️ outdated |
| Arch | `0.12.10` | ⚠️ outdated |
| Homebrew | `0.12.12` | ⚠️ outdated |
| Fedora rawhide | `0.12.12` | ⚠️ outdated |
...
_数据快照: `data/card/260910.yml` · 2026-09-10T21:24:14Z._
